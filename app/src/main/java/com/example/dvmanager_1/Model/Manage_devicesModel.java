...
public class Manage_devicesModel {
    ...
    public Manage_devicesModel() {
    }

    public Manage_devicesModel(String device_Name, Boolean blocked, Long scans_Today, Boolean logged_In, String logged_In_Email, Long battery_Remaining, String battery_Status, String network_Status, String actual_Location, GeoPoint GPS_Location) {
